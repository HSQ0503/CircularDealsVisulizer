...
### 3.5 Multi-Party Cycle Detection
...
### 3.6 Hub Score (Systemic Importance)
...
<div className="research-definition">
  ...
  <p className="research-definition-note">
    Where S(structure) is the Loop Score for two-party loops (Section 3.4) or Cycle Score for
    multi-party cycles (Section 3.5). Companies with higher Hub Scores participate in more
    circular structures and/or stronger ones. This aggregation across both structure types
    captures the full extent of a company&apos;s entanglement in circular flows.
  </p>
  <div className="research-definition-item">
...
<section className="research-citation">
  ...
  <div className="research-citation-box">
    <p>Han, S. (2025). Quantifying Circularity in AI Industry Deal Networks: A Graph-Based Analysis of Investment and Service Flows. <em>Working Paper</em>. Retrieved from https://aidealnetwork.com/research</p>
  </div>
  <p className="research-bibtex-label">BibTeX:</p>
  <pre className="research-bibtex">{`@article{han2025circularity,
